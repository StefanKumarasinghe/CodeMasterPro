...
export function DocumentationModal() {
  ...
  const hasPendingUploads =
    files.length > 0 || !!documentationText || !!documentationLinks;
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-4xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Add new knowledge by uploading files, entering text/links, or
              remove existing documents. For multiple links, separate them with
              commas.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-6 py-4 max-h-[70vh] overflow-y-auto pr-2">
            <div className="space-y-4 p-4 border rounded-lg">
              ...
              <div
                className={`border-2 border-dashed rounded-md p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:border-primary/50 transition-colors ${
              ...
              >
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  PDF, TXT, MD, DOC(X), PPT(X), CSV, XLS(X)
                </p>
              </div>
              ...
              <div>
                <Label htmlFor="documentation-links">
                  Or enter links (comma-separated):
                </Label>
                <Textarea
              ...
              {eraseLongTermMemory && (
                <div className="flex items-center gap-2 p-3 bg-destructive/10 rounded-md border border-destructive/20">
                  ...
                  <p className="text-sm text-destructive">
                    <strong>Warning:</strong> This erases <i>all</i> learned
                    info (files, text, links, browsing data). This cannot be
                    undone.
                  </p>
                </div>
              )}
            ...
            <div className="space-y-4 p-4 border rounded-lg">
              ...
              {isFetching ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="max-h-48 overflow-y-auto overflow-x-hidden  space-y-2 p-2 border rounded-md bg-muted/30">
                    {existingDocuments.map((doc) => (
                      <div
                        key={doc.id}
                        className="flex items-center justify-between bg-background p-2 rounded-md text-sm hover:bg-muted/50"
                      >
                        <div className="flex items-center gap-2 overflow-hidden flex-grow mr-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              handleRemoveSelectionChange(doc.id, checked)
                            }
            ...
            <div className="space-y-2 p-4 border border-destructive/30 rounded-lg bg-destructive/5">
              ...
              <div className="flex items-center justify-between gap-4">
                <p className="text-sm text-destructive/90 flex-grow">
                  Permanently erase <strong>all</strong> of TARS's long-term
                  memory, including documents, text, links, and browsing data and Cache and short term memory
                </p>
                <Button
                  type="button"
                  variant="destructive"
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              browsing data) and cannot be undone. TARS will revert to its
              initial state.
            </DialogDescription>
          </DialogHeader>
