  ...
  return (
    <>
      <header className="h-14 border-b px-4 flex md:flex items-center justify-between">
        ...
        {/* Add SaveChatButton to the right side of the header, before MemoryControls */}
        ...
        {showInfo && (
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-2">
              ...
              accuracy. CodeMasterPro owns TARS, however it is released as open source software under the MIT license
              for everyone to use and contribute to.
            </p>
