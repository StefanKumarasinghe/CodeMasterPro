...
import { Info, HelpCircle, Keyboard, PanelLeft } from "lucide-react"
        ...
        {showInfo && (
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mb-2">
              ...
              It is designed to be more specific to coding and also provide documentation and resources to assist it's accuracy.
              CodeMasterPro owns TARS, however it is released as open source software under the MIT license for everyone to use and contribute to.
            </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-mono bg-muted px-2 py-1 rounded text-xs">{isMac ? "⌘" : "Ctrl"}+B</span>
                    </div>
                  </div>
                </div>
                <Separator />
                <div>
                  <h3 className="font-medium mb-2">Code Actions</h3>
                   <p className="text-sm">Code actions are not supported yet, but will be added soon.</p>
                </div>
              </div>
