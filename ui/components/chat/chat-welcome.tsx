  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center px-4 py-3">
      ...
      >
        ...
        CodeMasterPro was developed by Stefan Kumarasinghe and is powered by Gemini's 3 models. CodeMasterPro is a product of Stefan Kumarasinghe and is not
        affiliated with or endorsed by any other company or organization. This is an open-source project and is not
        intended for commercial use. This application can be used by any software engineer (License: MIT). But please credit me
          </p>
