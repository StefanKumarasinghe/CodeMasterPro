  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center px-4 py-8">
      <motion.div
        ...
        className="w-full max-w-3xl mb-8 p-4 rounded-lg   flex flex-col items-center text-center gap-4"
      >
        <div>
          <p className="text-sm ">
            ...
            intended for commercial use. This application can be used by any software engineer (License: MIT).cd ..
          </p>
          <p className="text-sm font-semibold text-destructive-foreground mt-1">
            Think thrice before using any code generated by TARS.
          </p>
        </div>
      </motion.div>
      ...
      >
        <p className="mb-4">You will need to download the docker image to run the backend server locally.</p>

          <a
            href="https://hub.docker.com/repository/docker/stefankumarasinghe/tars-new"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-500 hover:underline  font-bold transition-colors"
          >
            docker pull stefankumarasinghe/tars-new
          </a>
            <div className="flex justify-center mt-4">
            <pre className="text-xs bg-dark text-wjtext-muted-foreground p-2 rounded-md">
      {`docker run -e GOOGLE_API_KEY=TOKEN -e BRAVE_API_KEY=TOKEN -p 8000:8000 stefankumarasinghe/tars-new`}
            </pre>
            </div>
