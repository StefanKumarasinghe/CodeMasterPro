  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center px-4 py-8">
      <motion.div
        ...
        className="w-full max-w-3xl mb-8 p-4 rounded-lg  shadow-md flex flex-col items-center text-center gap-4"
      >
        <div>
          <p className="text-sm ">All code generated by TARS is via Gemini API, which is a third-party service.
          </p>
